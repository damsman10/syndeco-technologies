    ...
    <div className="services-page font-montserrat">
      ...
      >
        ...
        <p className="max-w-2xl mx-auto text-gray-700 mb-12">
          Explore our signature solutions designed to deliver value fast and help you grow.
        </p>

        <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto">
          <motion.div
            className="bg-[#f9fafb] p-8 rounded-2xl text-left shadow-lg"
          ...
          >
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              Get your business online fast with a sleek, responsive website. Includes 5 custom pages, basic SEO, and mobile optimization — delivered in 7 days.
            </p>
            <p className="font-semibold text-[#003366] mb-4">$120 – One-time</p>
            <Link
              to="/services/webkit"
              className="inline-block bg-[#003366] text-white px-6 py-2 rounded-xl font-semibold shadow hover:bg-[#002244] transition"
            >
              Book Now
            </Link>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              Learn modern frontend development with hands-on guidance. Perfect for beginners or those looking to go pro with HTML, CSS, JS, and React.
            </p>
            <p className="font-semibold text-[#003366] mb-4">$150 – 10 Weeks</p>
            <Link
